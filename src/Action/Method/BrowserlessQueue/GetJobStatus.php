...
class GetJobStatus extends MethodAbstract
{
    ...
    {
        return 'BrowserlessQueue.GetJobStatus';
    }
    ...
    protected static function process(int $workerId, int $connectionId, MethodDTO $methodDTO): array
    {
        ...
        $value = JobType::BROWSERLESS->kvBucket()->get($jobId);
    ...
    {
        return 'Получить текущее состояние browserless-задачи по её идентификатору.';
    }
    ...
    {
        return OpenRpcSchema::browserlessJobSchema();
    }
}
